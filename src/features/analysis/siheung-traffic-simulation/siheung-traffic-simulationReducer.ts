...
const prefix = 'analysis_siheung-traffic-simulation'
...
export const {
    slice: SiheungTrafficSimulationSlice,
    actions: SiheungTrafficSimulationAction,
    saga: SiheungTrafficSimulationSaga,
} = module
